...
const API = axios.create({baseURL : `https://youtubeclone-serverside-rj.onrender.com`})
...
export const addToLikedVideo = (likeLikedData)=>API.post('/video/likeVideo',likeLikedData)
